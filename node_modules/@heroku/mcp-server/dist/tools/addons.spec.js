...
import { listAddonsOptionsSchema, getAddonInfoOptionsSchema, createAddonOptionsSchema, listAddonServicesOptionsSchema, listAddonPlansOptionsSchema, registerListAddonsTool, registerGetAddonInfoTool, registerCreateAddonTool, registerListAddonServicesTool, registerListAddonPlansTool } from './addons.js';
...
describe('addons topic tools', () => {
    describe('registerListAddonsTool', () => {
        ...
        it('executes command successfully with all flag', async () => {
            const expectedOutput = ' Owning app Add-on                  Plan                          Price        Max price State   \n' +
                ' ────────── ─────────────────────── ───────────────────────────── ──────────── ───────── ─────── \n' +
        ...
        it('executes command successfully with app flag', async () => {
            const expectedOutput = ' Add-on                                Plan Price        Max price State   \n' +
                ' ───────────────────────────────────── ──── ──────────── ───────── ─────── \n' +
    ...
    describe('registerGetAddonInfoTool', () => {
        ...
        it('executes command successfully with add-on name', async () => {
            const expectedOutput = '=== postgresql-curved-12345\n\n' +
    ...
    describe('registerCreateAddonTool', () => {
        ...
        it('executes command successfully with all options', async () => {
            const expectedOutput = 'Creating heroku-postgresql:essential-0 on test-app... ~$0.007/hour (max $5/month)\n' +
    ...
    describe('registerListAddonServicesTool', () => {
        ...
        it('executes command successfully', async () => {
            const expectedOutput = ' Slug              Name                   State \n' +
                ' ───────────────── ────────────────────── ───── \n' +
    ...
    describe('registerListAddonPlansTool', () => {
        ...
        it('executes command successfully', async () => {
            const expectedOutput = '         Slug                           Name         Price         Max price    \n' +
                ' ─────── ────────────────────────────── ──────────── ───────────── ──────────── \n' +
            ...
            for (const tool of tools) {
                ...
                expect(result).to.deep.equal({
                    ...
                    content: [
                        {
                            type: 'text',
                            text: '[Heroku MCP Server Error] Please use available tools to resolve this issue. ' +
