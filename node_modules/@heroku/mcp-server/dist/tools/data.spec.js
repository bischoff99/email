...
import { registerPgPsqlTool, registerPgInfoTool, registerPgPsTool, registerPgKillTool, registerPgBackupsTool, registerPgUpgradeTool } from './data.js';
...
describe('PostgreSQL Tools', () => {
    ...
    describe('pg:psql', () => {
        ...
        it('should build correct command with required parameters', async () => {
            ...
            expect(mocks.herokuRepl.executeCommand.firstCall.args[0]).to.equal(`${TOOL_COMMAND_MAP.PG_PSQL} --app=myapp --command=""`);
        });
        it('should build correct command with all parameters', async () => {
            ...
            expect(mocks.herokuRepl.executeCommand.calledOnce).to.be.true;
            expect(mocks.herokuRepl.executeCommand.firstCall.args[0]).to.equal(`${TOOL_COMMAND_MAP.PG_PSQL} --app=myapp --command="SELECT * FROM users" --file=query.sql --credential=mycred -- HEROKU_POSTGRESQL_RED`);
        });
    ...
    describe('pg:info', () => {
        ...
        it('should build correct command with required parameters', async () => {
            const successResponse = '=== DATABASE_URL\nPlan:                  Hobby-dev\nStatus:                Available\nConnections:           0/20\nPG Version:            14.9\n';
        ...
        it('should build correct command with database parameter', async () => {
            const successResponse = '=== HEROKU_POSTGRESQL_RED\nPlan:                  Standard-0\nStatus:                Available\n';
            mocks.herokuRepl.executeCommand.resolves(successResponse);
            await toolCallback({ app: 'myapp', database: 'HEROKU_POSTGRESQL_RED' });
            expect(mocks.herokuRepl.executeCommand.calledOnce).to.be.true;
            expect(mocks.herokuRepl.executeCommand.firstCall.args[0]).to.equal(`${TOOL_COMMAND_MAP.PG_INFO} --app=myapp -- HEROKU_POSTGRESQL_RED`);
        });
        it('should handle error response', async () => {
            const errorResponse = '<<<ERROR>>>\nError: Database not found\n<<<END ERROR>>>\n';
            mocks.herokuRepl.executeCommand.resolves(errorResponse);
    ...
    describe('pg:ps', () => {
        ...
        it('should build correct command with required parameters', async () => {
            const successResponse = ' pid | state | source | running_for | waiting | query\n-----+-------+--------+-------------+---------+-------\n';
            mocks.herokuRepl.executeCommand.resolves(successResponse);
            await toolCallback({ app: 'myapp' });
            expect(mocks.herokuRepl.executeCommand.calledOnce).to.be.true;
        ...
        it('should build correct command with all parameters', async () => {
            const successResponse = ' pid | state | source | running_for | waiting | query | memory\n-----+-------+--------+-------------+---------+-------+--------\n';
            mocks.herokuRepl.executeCommand.resolves(successResponse);
            await toolCallback({
                app: 'myapp',
                verbose: true,
            ...
            expect(mocks.herokuRepl.executeCommand.calledOnce).to.be.true;
            expect(mocks.herokuRepl.executeCommand.firstCall.args[0]).to.equal(`${TOOL_COMMAND_MAP.PG_PS} --app=myapp --verbose -- HEROKU_POSTGRESQL_RED`);
        });
        it('should handle error response', async () => {
            const errorResponse = '<<<ERROR>>>\nError: Database not found\n<<<END ERROR>>>\n';
            mocks.herokuRepl.executeCommand.resolves(errorResponse);
    ...
    describe('pg:kill', () => {
        ...
        it('should build correct command with required parameters', async () => {
            ...
            expect(mocks.herokuRepl.executeCommand.calledOnce).to.be.true;
            expect(mocks.herokuRepl.executeCommand.firstCall.args[0]).to.equal(`${TOOL_COMMAND_MAP.PG_KILL} --app=myapp -- 12345`);
        });
        it('should build correct command with all parameters', async () => {
            const successResponse = 'Terminating process 12345... done\n';
            mocks.herokuRepl.executeCommand.resolves(successResponse);
            ...
            expect(mocks.herokuRepl.executeCommand.calledOnce).to.be.true;
            expect(mocks.herokuRepl.executeCommand.firstCall.args[0]).to.equal(`${TOOL_COMMAND_MAP.PG_KILL} --app=myapp --force -- 12345 HEROKU_POSTGRESQL_RED`);
        });
        it('should handle error response', async () => {
    ...
    describe('pg:upgrade', () => {
        ...
        it('should build correct command with all parameters', async () => {
            ...
            expect(mocks.herokuRepl.executeCommand.calledOnce).to.be.true;
            expect(mocks.herokuRepl.executeCommand.firstCall.args[0]).to.equal(`${TOOL_COMMAND_MAP.PG_UPGRADE} --app=myapp --version=14 --confirm=myapp -- HEROKU_POSTGRESQL_RED`);
        });
        it('should handle error response', async () => {
