...
import { registerListAiAvailableModelsTool, registerProvisionAiModelTool, provisionAiModelOptionsSchema, registerMakeAiInferenceTool, aiInferenceOptionsSchema } from './ai.js';
...
describe('ai topic tools', () => {
    describe('listAiAvailableModelsTool', () => {
        ...
        it('executes command successfully', async () => {
            const expectedOutput = ' Model                     Type              Supported regions \n' +
                ' ───────────────────────── ───────────────── ───────────────── \n' +
    ...
    describe('provisionAiModelTool', () => {
        ...
        it('executes command successfully with required arguments', async () => {
            const expectedOutput = 'Provisioning access to claude-3-5-sonnet-latest for app test-app... done\n' +
        ...
        it('executes command successfully with optional "--as" parameter', async () => {
            const expectedOutput = 'Provisioning access to claude-3-5-sonnet-latest for app test-app as MY_MODEL... done\n' +
