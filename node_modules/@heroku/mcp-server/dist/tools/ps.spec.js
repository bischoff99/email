...
describe('Process Management Tools', () => {
    ...
    describe('ps:scale', () => {
        ...
        it('should build correct command with required parameters', async () => {
            ...
            expect(mocks.herokuRepl.executeCommand.calledOnce).to.be.true;
            expect(mocks.herokuRepl.executeCommand.firstCall.args[0]).to.equal(`${TOOL_COMMAND_MAP.PS_SCALE} --app=myapp -- web=2`);
        });
    ...
    describe('ps:restart', () => {
        ...
        it('should build correct command with specific dyno', async () => {
            ...
            expect(mocks.herokuRepl.executeCommand.calledOnce).to.be.true;
            expect(mocks.herokuRepl.executeCommand.firstCall.args[0]).to.equal(`${TOOL_COMMAND_MAP.PS_RESTART} --app=myapp --dyno-name=web.1`);
        });
        it('should build correct command with all parameters', async () => {
            ...
            expect(mocks.herokuRepl.executeCommand.calledOnce).to.be.true;
            expect(mocks.herokuRepl.executeCommand.firstCall.args[0]).to.equal(`${TOOL_COMMAND_MAP.PS_RESTART} --app=myapp --dyno-name=web.1 --process-type=web`);
        });
    });
});
