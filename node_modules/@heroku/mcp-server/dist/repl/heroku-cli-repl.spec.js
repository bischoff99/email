...
describe('HerokuREPL', () => {
    ...
    beforeEach(() => {
        ...
        spawnStub = sinon.stub(HerokuREPL, 'spawn').returns(mockProcess);
    ...
    describe('initialization', () => {
        it('should create a new process when initialized', () => {
            ...
            expect(spawnStub.firstCall.args[2].env.HEROKU_HEADERS).to.equal(JSON.stringify({
    ...
    describe('getHerokuCliCommandAndArgs', () => {
        ...
        it('should emit fatalError and return null when npx is not available and heroku CLI is not available', () => {
            ...
            expect(fatalSpy.called).to.be.true;
            const mcpError = fatalSpy.firstCall.args[0];
            expect(mcpError.content[0].text).to.include('Startup error: npx is not installed and Heroku CLI (10.10.0+) is not available');
        });
