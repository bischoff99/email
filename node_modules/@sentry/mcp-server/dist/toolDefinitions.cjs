...
//#region src/toolDefinitions.json
var toolDefinitions_default$1 = [
	{
		"name": "whoami",
	...
	},
	{
		...
		"inputSchema": {
			"organizationSlug": { "description": "The organization's slug. You can find a existing list of organizations you have access to using the `find_organizations()` tool." },
			"regionUrl": { "description": "The region URL for the organization you're querying, if known. For Sentry's Cloud Service (sentry.io), this is typically the region-specific URL like 'https://us.sentry.io'. For self-hosted Sentry installations, this parameter is usually not needed and should be omitted. You can find the correct regionUrl from the organization details using the `find_organizations()` tool." }
		}
	},
	{
		"name": "find_projects",
	...
	},
	{
		...
		"inputSchema": {
			"organizationSlug": { "description": "The organization's slug. You can find a existing list of organizations you have access to using the `find_organizations()` tool." },
			"regionUrl": { "description": "The region URL for the organization you're querying, if known. For Sentry's Cloud Service (sentry.io), this is typically the region-specific URL like 'https://us.sentry.io'. For self-hosted Sentry installations, this parameter is usually not needed and should be omitted. You can find the correct regionUrl from the organization details using the `find_organizations()` tool." },
			"projectSlug": { "description": "The project's slug. This will default to all projects you have access to. It is encouraged to specify this when possible." },
			"query": { "description": "Search for versions which contain the provided string." }
		}
	},
	{
		...
		"inputSchema": {
			"organizationSlug": { "description": "The organization's slug. You can find a existing list of organizations you have access to using the `find_organizations()` tool." },
			"regionUrl": { "description": "The region URL for the organization you're querying, if known. For Sentry's Cloud Service (sentry.io), this is typically the region-specific URL like 'https://us.sentry.io'. For self-hosted Sentry installations, this parameter is usually not needed and should be omitted. You can find the correct regionUrl from the organization details using the `find_organizations()` tool." },
			"issueId": { "description": "The Issue ID. e.g. `PROJECT-1Z43`" },
			"eventId": { "description": "The ID of the event." },
			"issueUrl": { "description": "The URL of the issue. e.g. https://my-organization.sentry.io/issues/PROJECT-1Z43" }
		}
	},
	{
		...
		"inputSchema": {
			"organizationSlug": { "description": "The organization's slug. You can find a existing list of organizations you have access to using the `find_organizations()` tool." },
			"projectSlug": { "description": "The project's slug. You can find a list of existing projects in an organization using the `find_projects()` tool." },
			"eventId": { "description": "The ID of the event." },
			"attachmentId": { "description": "The ID of the attachment to download." },
			"regionUrl": { "description": "The region URL for the organization you're querying, if known. For Sentry's Cloud Service (sentry.io), this is typically the region-specific URL like 'https://us.sentry.io'. For self-hosted Sentry installations, this parameter is usually not needed and should be omitted. You can find the correct regionUrl from the organization details using the `find_organizations()` tool." }
		}
	},
	{
		...
		"inputSchema": {
			...
			"issueId": { "description": "The Issue ID. e.g. `PROJECT-1Z43`" },
			"issueUrl": { "description": "The URL of the issue. e.g. https://my-organization.sentry.io/issues/PROJECT-1Z43" },
			"status": { "description": "The new status for the issue. Valid values are 'resolved', 'resolvedInNextRelease', 'unresolved', and 'ignored'." },
			"assignedTo": { "description": "The assignee in format 'user:ID' or 'team:ID' where ID is numeric. Example: 'user:123456' or 'team:789'. Use the whoami tool to find your user ID." }
		}
	},
	{
		"name": "search_events",
		...
		"inputSchema": {
			"organizationSlug": { "description": "The organization's slug. You can find a existing list of organizations you have access to using the `find_organizations()` tool." },
			"naturalLanguageQuery": { "description": "Natural language description of what you want to search for" },
			"projectSlug": { "description": "The project's slug. You can find a list of existing projects in an organization using the `find_projects()` tool." },
			"regionUrl": { "description": "The region URL for the organization you're querying, if known. For Sentry's Cloud Service (sentry.io), this is typically the region-specific URL like 'https://us.sentry.io'. For self-hosted Sentry installations, this parameter is usually not needed and should be omitted. You can find the correct regionUrl from the organization details using the `find_organizations()` tool." },
			"limit": { "description": "Maximum number of results to return" },
			"includeExplanation": { "description": "Include explanation of how the query was translated" }
		}
	},
	{
		"name": "create_team",
		...
		"inputSchema": {
			"organizationSlug": { "description": "The organization's slug. You can find a existing list of organizations you have access to using the `find_organizations()` tool." },
			"regionUrl": { "description": "The region URL for the organization you're querying, if known. For Sentry's Cloud Service (sentry.io), this is typically the region-specific URL like 'https://us.sentry.io'. For self-hosted Sentry installations, this parameter is usually not needed and should be omitted. You can find the correct regionUrl from the organization details using the `find_organizations()` tool." },
			"name": { "description": "The name of the team to create." }
		}
	},
	{
		"name": "create_project",
		...
		"inputSchema": {
			"organizationSlug": { "description": "The organization's slug. You can find a existing list of organizations you have access to using the `find_organizations()` tool." },
			"regionUrl": { "description": "The region URL for the organization you're querying, if known. For Sentry's Cloud Service (sentry.io), this is typically the region-specific URL like 'https://us.sentry.io'. For self-hosted Sentry installations, this parameter is usually not needed and should be omitted. You can find the correct regionUrl from the organization details using the `find_organizations()` tool." },
			"teamSlug": { "description": "The team's slug. You can find a list of existing teams in an organization using the `find_teams()` tool." },
			"name": { "description": "The name of the project to create. Typically this is commonly the name of the repository or service. It is only used as a visual label in Sentry." },
			"platform": { "description": "The platform for the project. e.g., python, javascript, react, etc." }
		}
	},
	{
		"name": "update_project",
		...
		"inputSchema": {
			...
			"regionUrl": { "description": "The region URL for the organization you're querying, if known. For Sentry's Cloud Service (sentry.io), this is typically the region-specific URL like 'https://us.sentry.io'. For self-hosted Sentry installations, this parameter is usually not needed and should be omitted. You can find the correct regionUrl from the organization details using the `find_organizations()` tool." },
			"projectSlug": { "description": "The project's slug. You can find a list of existing projects in an organization using the `find_projects()` tool." },
			"name": { "description": "The new name for the project" },
			"slug": { "description": "The new slug for the project (must be unique)" },
			"platform": { "description": "The platform for the project. e.g., python, javascript, react, etc." },
			"teamSlug": { "description": "The team to assign this project to. Note: this will replace the current team assignment." }
		}
	},
	{
		"name": "create_dsn",
		...
		"inputSchema": {
			...
			"regionUrl": { "description": "The region URL for the organization you're querying, if known. For Sentry's Cloud Service (sentry.io), this is typically the region-specific URL like 'https://us.sentry.io'. For self-hosted Sentry installations, this parameter is usually not needed and should be omitted. You can find the correct regionUrl from the organization details using the `find_organizations()` tool." },
			"projectSlug": { "description": "The project's slug. You can find a list of existing projects in an organization using the `find_projects()` tool." },
			"name": { "description": "The name of the DSN to create, for example 'Production'." }
		}
	},
	{
		"name": "find_dsns",
	...
	},
	{
		...
		"inputSchema": {
			...
			"issueId": { "description": "The Issue ID. e.g. `PROJECT-1Z43`" },
			"issueUrl": { "description": "The URL of the issue. e.g. https://my-organization.sentry.io/issues/PROJECT-1Z43" },
			"instruction": { "description": "Optional custom instruction for the AI analysis" }
		}
	},
	{
		"name": "search_docs",
		...
		"inputSchema": {
			"query": { "description": "The search query in natural language. Be specific about what you're looking for." },
			"maxResults": { "description": "Maximum number of results to return (1-10)" },
			"guide": { "description": "Optional guide filter to limit search results to specific documentation sections. Use either a platform (e.g., 'javascript', 'python') or platform/guide combination (e.g., 'javascript/nextjs', 'python/django')." }
		}
	},
	{
		"name": "get_doc",
		...
		"inputSchema": { "path": { "description": "The documentation path (e.g., '/platforms/javascript/guides/nextjs.md'). Get this from search_docs results." } }
	},
	{
		"name": "search_issues",
		...
		"inputSchema": {
			"organizationSlug": { "description": "The organization's slug. You can find a existing list of organizations you have access to using the `find_organizations()` tool." },
			"naturalLanguageQuery": { "description": "Natural language description of issues to search for" },
			"projectSlugOrId": { "description": "The project's slug or numeric ID (optional)" },
			"regionUrl": { "description": "The region URL for the organization you're querying, if known. For Sentry's Cloud Service (sentry.io), this is typically the region-specific URL like 'https://us.sentry.io'. For self-hosted Sentry installations, this parameter is usually not needed and should be omitted. You can find the correct regionUrl from the organization details using the `find_organizations()` tool." },
...
const toolDefinitions = toolDefinitions_default$1;
var toolDefinitions_default = toolDefinitions;

//#endregion
module.exports = toolDefinitions_default;
//# sourceMappingURL=toolDefinitions.cjs.map