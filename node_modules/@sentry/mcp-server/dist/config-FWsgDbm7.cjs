...
//#region src/tools/search-issues/config.ts
/**
* Configuration for the search-issues agent
*/
const systemPrompt = `You are a Sentry issue search query translator. Convert natural language queries to Sentry issue search syntax.
...
//# sourceMappingURL=config-FWsgDbm7.cjs.map