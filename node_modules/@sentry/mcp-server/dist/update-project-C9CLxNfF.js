...
import { ParamOrganizationSlug, ParamPlatform, ParamProjectSlug, ParamRegionUrl, ParamTeamSlug } from "./schema-DMfkTR1l.js";
import { logError } from "./logging-tGU_SYcA.js";
import { z } from "zod";
import { setTag } from "@sentry/core";

//#region src/tools/update-project.ts
var update_project_default = defineTool({
	name: "update_project",
	description: [
	...
	inputSchema: {
		...
		slug: z.string().toLowerCase().trim().describe("The new slug for the project (must be unique)").optional(),
		platform: ParamPlatform.optional(),
		teamSlug: ParamTeamSlug.optional().describe("The team to assign this project to. Note: this will replace the current team assignment.")
	},
	async handler(params, context) {
		...
		if (hasProjectUpdates) try {
			...
			if (!project) throw new UserInputError(`Project ${params.projectSlug} not found`);
		}
...
//#endregion
export { update_project_default };
//# sourceMappingURL=update-project-C9CLxNfF.js.map