...
import { ParamOrganizationSlug, ParamProjectSlugOrAll, ParamRegionUrl } from "./schema-DMfkTR1l.js";
import { z } from "zod";
import { setTag } from "@sentry/core";

//#region src/tools/find-releases.ts
var find_releases_default = defineTool({
	name: "find_releases",
	description: [
	...
	inputSchema: {
		...
		query: z.string().trim().describe("Search for versions which contain the provided string.").optional()
	},
...
//#endregion
export { find_releases_default };
//# sourceMappingURL=find-releases-Do_CywRr.js.map