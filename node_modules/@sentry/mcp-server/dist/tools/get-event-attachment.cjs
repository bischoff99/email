...
require('../url-utils-vJo2ER5v.cjs');
...
const require_get_event_attachment = require('../get-event-attachment-BzhDeM6z.cjs');

module.exports = require_get_event_attachment.get_event_attachment_default;