...
//#region src/agent-tools/data/android.json
var namespace$72 = "android";
var description$72 = "The Android platform on which the Android application is running.\n";
var attributes$72 = {
...
var android_default = {
	namespace: namespace$72,
	description: description$72,
	attributes: attributes$72
};

//#endregion
//#region src/agent-tools/data/app.json
var namespace$71 = "app";
var description$71 = "Describes attributes related to client-side applications (e.g. web apps or mobile apps).\n";
var attributes$71 = {
	"app.installation.id": {
...
//#endregion
//#region src/agent-tools/data/artifact.json
var namespace$70 = "artifact";
var description$70 = "This group describes attributes specific to artifacts. Artifacts are files or other immutable objects that are intended for distribution. This definition aligns directly with the [SLSA](https://slsa.dev/spec/v1.0/terminology#package-model) package model.\n";
var attributes$70 = {
	"artifact.filename": {
	...
	"artifact.purl": {
		...
		"type": "string",
		"stability": "development",
		"examples": ["pkg:github/package-url/purl-spec@1209109710924", "pkg:npm/foo@12.12.3"]
	},
	"artifact.hash": {
...
//#endregion
//#region src/agent-tools/data/aspnetcore.json
var namespace$69 = "aspnetcore";
var description$69 = "ASP.NET Core attributes";
var attributes$69 = {
...
//#endregion
//#region src/agent-tools/data/aws.json
var namespace$68 = "aws";
var description$68 = "This section defines generic attributes for AWS services.\n";
var attributes$68 = {
	"aws.request_id": {
	...
	"aws.extended_request_id": {
		...
		"type": "string",
		"stability": "development",
		"examples": ["wzHcyEWfmOGDIE5QOhTAqFDoDWP3y8IUvpNINCwL9N4TEHbUw0/gZJ+VZTmCNCWR7fezEN3eCiQ="]
	}
};
var aws_default = {
...
//#endregion
//#region src/agent-tools/data/azure.json
var namespace$67 = "azure";
var description$67 = "This section defines generic attributes used by Azure Client Libraries.\n";
var attributes$67 = {
...
//#endregion
//#region src/agent-tools/data/browser.json
var namespace$66 = "browser";
var description$66 = "The web browser attributes\n";
var attributes$66 = {
	"browser.brands": {
...
//#endregion
//#region src/agent-tools/data/cassandra.json
var namespace$65 = "cassandra";
var description$65 = "This section defines attributes for Cassandra.\n";
var attributes$65 = {
...
var attributes$64 = {
	...
	"cicd.pipeline.run.url.full": {
		...
		"type": "string",
		"stability": "development",
		"examples": ["https://github.com/open-telemetry/semantic-conventions/actions/runs/9753949763?pr=1075"]
	},
	...
	"cicd.pipeline.task.run.url.full": {
		...
		"type": "string",
		"stability": "development",
		"examples": ["https://github.com/open-telemetry/semantic-conventions/actions/runs/9753949763/job/26920038674?pr=1075"]
	},
...
//#endregion
//#region src/agent-tools/data/client.json
var namespace$63 = "client";
var description$63 = "These attributes may be used to describe the client in a connection-based network interaction where there is one side that initiates the connection (the client is the side that initiates the connection). This covers all TCP network interactions since TCP is connection-based and one side initiates the connection (an exception is made for peer-to-peer communication over TCP where the \"user-facing\" surface of the protocol / API doesn't expose a clear notion of client and server). This also covers UDP network interactions where one side initiates the interaction, e.g. QUIC (HTTP/3) and DNS.\n";
var attributes$63 = {
	"client.address": {
...
//#endregion
//#region src/agent-tools/data/cloud.json
var namespace$62 = "cloud";
var description$62 = "A cloud environment (e.g. GCP, Azure, AWS).\n";
var attributes$62 = {
	"cloud.provider": {
...
var cloud_default = {
	namespace: namespace$62,
	description: description$62,
	attributes: attributes$62
};

//#endregion
//#region src/agent-tools/data/cloudevents.json
var namespace$61 = "cloudevents";
var description$61 = "This document defines attributes for CloudEvents.\n";
var attributes$61 = {
...
//#endregion
//#region src/agent-tools/data/cloudfoundry.json
var namespace$60 = "cloudfoundry";
var description$60 = "CloudFoundry resource attributes.\n";
var attributes$60 = {
...
//#endregion
//#region src/agent-tools/data/code.json
var namespace$59 = "code";
var description$59 = "These attributes provide context about source code\n";
var attributes$59 = {
	"code.function.name": {
...
//#endregion
//#region src/agent-tools/data/container.json
var namespace$58 = "container";
var description$58 = "A container instance.\n";
var attributes$58 = {
	"container.name": {
	...
	"container.image.repo_digests": {
		...
		"stability": "development",
		"examples": ["[\"example@sha256:afcc7f1ac1b49db317a7196c902e61c6c3c4607d63599ee1a82d702d249a0ccb\",\"internal.registry.example.com:5000/example@sha256:b69959407d21e8a062e0416bf13405bb2b71ed7a84dde4158ebafacfa06f5578\"]"]
	},
	"container.command": {
...
//#endregion
//#region src/agent-tools/data/cpu.json
var namespace$57 = "cpu";
var description$57 = "Attributes specific to a cpu instance.";
var attributes$57 = {
	"cpu.mode": {
...
var cpu_default = {
	namespace: namespace$57,
	description: description$57,
	attributes: attributes$57
};

//#endregion
//#region src/agent-tools/data/cpython.json
var namespace$56 = "cpython";
var description$56 = "This document defines CPython related attributes.\n";
var attributes$56 = { "cpython.gc.generation": {
...
var cpython_default = {
	namespace: namespace$56,
	description: description$56,
	attributes: attributes$56
};

//#endregion
//#region src/agent-tools/data/database.json
var namespace$55 = "database";
var description$55 = "This group defines the attributes used to describe telemetry in the context of databases.\n";
var attributes$55 = {
	"db.collection.name": {
...
var database_default = {
	namespace: namespace$55,
	description: description$55,
	attributes: attributes$55
};

//#endregion
//#region src/agent-tools/data/db.json
var namespace$54 = "db";
var description$54 = "Database operations attributes";
var attributes$54 = {
	"db.system.name": {
...
var db_default = {
	namespace: namespace$54,
	description: description$54,
	attributes: attributes$54
};

//#endregion
//#region src/agent-tools/data/deployment.json
var namespace$53 = "deployment";
var description$53 = "This document defines attributes for software deployments.\n";
var attributes$53 = {
	"deployment.name": {
...
//#endregion
//#region src/agent-tools/data/device.json
var namespace$51 = "device";
var description$51 = "Describes device attributes.\n";
var attributes$51 = {
	"device.id": {
...
var device_default = {
	namespace: namespace$51,
	description: description$51,
	attributes: attributes$51
};

//#endregion
//#region src/agent-tools/data/disk.json
var namespace$50 = "disk";
var description$50 = "These attributes may be used for any disk related operation.\n";
var attributes$50 = { "disk.io.direction": {
...
//#endregion
//#region src/agent-tools/data/dns.json
var namespace$49 = "dns";
var description$49 = "This document defines the shared attributes used to report a DNS query.\n";
var attributes$49 = {
	"dns.question.name": {
...
//#endregion
//#region src/agent-tools/data/dotnet.json
var namespace$48 = "dotnet";
var description$48 = "This document defines .NET related attributes.\n";
var attributes$48 = { "dotnet.gc.heap.generation": {
...
var dotnet_default = {
	namespace: namespace$48,
	description: description$48,
	attributes: attributes$48
};

//#endregion
//#region src/agent-tools/data/elasticsearch.json
var namespace$47 = "elasticsearch";
var description$47 = "This section defines attributes for Elasticsearch.\n";
var attributes$47 = { "elasticsearch.node.name": {
	"description": "Represents the human-readable identifier of the node/instance to which a request was routed.\n",
	"type": "string",
	"stability": "development",
	"examples": ["instance-0000000001"]
} };
var elasticsearch_default = {
...
//#endregion
//#region src/agent-tools/data/enduser.json
var namespace$46 = "enduser";
var description$46 = "Describes the end user.\n";
var attributes$46 = {
	"enduser.id": {
...
//#endregion
//#region src/agent-tools/data/error.json
var namespace$45 = "error";
var description$45 = "This document defines the shared attributes used to report an error.\n";
var attributes$45 = {
	"error.type": {
...
var error_default = {
	namespace: namespace$45,
	description: description$45,
	attributes: attributes$45
};

//#endregion
//#region src/agent-tools/data/faas.json
var namespace$44 = "faas";
var description$44 = "FaaS attributes";
var attributes$44 = {
	"faas.name": {
...
var faas_default = {
	namespace: namespace$44,
	description: description$44,
	attributes: attributes$44
};

//#endregion
//#region src/agent-tools/data/feature_flags.json
var namespace$43 = "feature_flags";
var description$43 = "This document defines attributes for Feature Flags.\n";
var attributes$43 = {
	"feature_flag.key": {
...
//#endregion
//#region src/agent-tools/data/file.json
var namespace$42 = "file";
var description$42 = "Describes file attributes.";
var attributes$42 = {
	"file.accessed": {
...
//#endregion
//#region src/agent-tools/data/gcp.json
var namespace$41 = "gcp";
var description$41 = "Attributes for Google Cloud client libraries.\n";
var attributes$41 = { "gcp.client.service": {
...
var gcp_default = {
	namespace: namespace$41,
	description: description$41,
	attributes: attributes$41
};

//#endregion
//#region src/agent-tools/data/gen_ai.json
var namespace$40 = "gen_ai";
var description$40 = "This document defines the attributes used to describe telemetry in the context of Generative Artificial Intelligence (GenAI) Models requests and responses.\n";
var attributes$40 = {
...
var geo_default = {
	namespace: namespace$39,
	description: description$39,
	attributes: attributes$39
};

//#endregion
//#region src/agent-tools/data/go.json
var namespace$38 = "go";
var description$38 = "This document defines Go related attributes.\n";
var attributes$38 = { "go.memory.type": {
...
var go_default = {
	namespace: namespace$38,
	description: description$38,
	attributes: attributes$38
};

//#endregion
//#region src/agent-tools/data/graphql.json
var namespace$37 = "graphql";
var description$37 = "This document defines attributes for GraphQL.";
var attributes$37 = {
...
var graphql_default = {
	namespace: namespace$37,
	description: description$37,
	attributes: attributes$37
};

//#endregion
//#region src/agent-tools/data/hardware.json
var namespace$36 = "hardware";
var description$36 = "Attributes for hardware.\n";
var attributes$36 = {
	"hw.id": {
...
var hardware_default = {
	namespace: namespace$36,
	description: description$36,
	attributes: attributes$36
};

//#endregion
//#region src/agent-tools/data/heroku.json
var namespace$35 = "heroku";
var description$35 = "This document defines attributes for the Heroku platform on which application/s are running.\n";
var attributes$35 = {
...
//#endregion
//#region src/agent-tools/data/host.json
var namespace$34 = "host";
var description$34 = "A host is defined as a computing instance. For example, physical servers, virtual machines, switches or disk array.\n";
var attributes$34 = {
	"host.id": {
...
//#endregion
//#region src/agent-tools/data/http.json
var namespace$33 = "http";
var description$33 = "This document defines semantic convention attributes in the HTTP namespace.";
var attributes$33 = {
...
var http_default = {
	namespace: namespace$33,
	description: description$33,
	attributes: attributes$33
};

//#endregion
//#region src/agent-tools/data/ios.json
var namespace$32 = "ios";
var description$32 = "This group describes iOS-specific attributes.\n";
var attributes$32 = { "ios.app.state": {
	"description": "This attribute represents the state of the application.\n",
	"type": "string",
...
//#endregion
//#region src/agent-tools/data/jvm.json
var namespace$31 = "jvm";
var description$31 = "This document defines Java Virtual machine related attributes.\n";
var attributes$31 = {
	"jvm.gc.action": {
...
var jvm_default = {
	namespace: namespace$31,
	description: description$31,
	attributes: attributes$31
};

//#endregion
//#region src/agent-tools/data/k8s.json
var namespace$30 = "k8s";
var description$30 = "Kubernetes resource attributes.\n";
var attributes$30 = {
	"k8s.cluster.name": {
...
//#endregion
//#region src/agent-tools/data/linux.json
var namespace$29 = "linux";
var description$29 = "Describes Linux Memory attributes";
var attributes$29 = { "linux.memory.slab.state": {
...
var linux_default = {
	namespace: namespace$29,
	description: description$29,
	attributes: attributes$29
};

//#endregion
//#region src/agent-tools/data/log.json
var namespace$28 = "log";
var description$28 = "This document defines log attributes\n";
var attributes$28 = { "log.iostream": {
...
//#endregion
//#region src/agent-tools/data/mcp.json
var namespace$27 = "mcp";
var description$27 = "Model Context Protocol attributes for MCP tool calls and sessions";
var attributes$27 = {
	"mcp.tool.name": {
...
//#endregion
//#region src/agent-tools/data/messaging.json
var namespace$26 = "messaging";
var description$26 = "Attributes describing telemetry around messaging systems and messaging activities.";
var attributes$26 = {
...
var messaging_default = {
	namespace: namespace$26,
	description: description$26,
	attributes: attributes$26
};

//#endregion
//#region src/agent-tools/data/network.json
var namespace$25 = "network";
var description$25 = "These attributes may be used for any network related operation.\n";
var attributes$25 = {
	"network.carrier.icc": {
...
//#endregion
//#region src/agent-tools/data/nodejs.json
var namespace$24 = "nodejs";
var description$24 = "Describes Node.js related attributes.";
var attributes$24 = { "nodejs.eventloop.state": {
...
var nodejs_default = {
	namespace: namespace$24,
	description: description$24,
	attributes: attributes$24
};

//#endregion
//#region src/agent-tools/data/oci.json
var namespace$23 = "oci";
var description$23 = "An OCI image manifest.\n";
var attributes$23 = { "oci.manifest.digest": {
...
//#endregion
//#region src/agent-tools/data/opentracing.json
var namespace$22 = "opentracing";
var description$22 = "Attributes used by the OpenTracing Shim layer.";
var attributes$22 = { "opentracing.ref_type": {
...
var opentracing_default = {
	namespace: namespace$22,
	description: description$22,
	attributes: attributes$22
};

//#endregion
//#region src/agent-tools/data/os.json
var namespace$21 = "os";
var description$21 = "The operating system (OS) on which the process represented by this resource is running.\n";
var attributes$21 = {
	"os.type": {
...
//#endregion
//#region src/agent-tools/data/otel.json
var namespace$20 = "otel";
var description$20 = "Attributes reserved for OpenTelemetry";
var attributes$20 = {
	"otel.status_code": {
...
//#endregion
//#region src/agent-tools/data/peer.json
var namespace$19 = "peer";
var description$19 = "Operations that access some remote service.\n";
var attributes$19 = { "peer.service": {
...
//#endregion
//#region src/agent-tools/data/process.json
var namespace$18 = "process";
var description$18 = "An operating system process.\n";
var attributes$18 = {
	"process.pid": {
...
//#endregion
//#region src/agent-tools/data/profile.json
var namespace$17 = "profile";
var description$17 = "Describes the origin of a single frame in a Profile.\n";
var attributes$17 = { "profile.frame.type": {
...
//#endregion
//#region src/agent-tools/data/rpc.json
var namespace$16 = "rpc";
var description$16 = "This document defines attributes for remote procedure calls.";
var attributes$16 = {
...
//#endregion
//#region src/agent-tools/data/server.json
var namespace$15 = "server";
var description$15 = "These attributes may be used to describe the server in a connection-based network interaction where there is one side that initiates the connection (the client is the side that initiates the connection). This covers all TCP network interactions since TCP is connection-based and one side initiates the connection (an exception is made for peer-to-peer communication over TCP where the \"user-facing\" surface of the protocol / API doesn't expose a clear notion of client and server). This also covers UDP network interactions where one side initiates the interaction, e.g. QUIC (HTTP/3) and DNS.\n";
var attributes$15 = {
	"server.address": {
...
//#endregion
//#region src/agent-tools/data/service.json
var namespace$14 = "service";
var description$14 = "A service instance.\n";
var attributes$14 = {
	"service.name": {
...
//#endregion
//#region src/agent-tools/data/signalr.json
var namespace$12 = "signalr";
var description$12 = "SignalR attributes";
var attributes$12 = {
...
//#endregion
//#region src/agent-tools/data/source.json
var namespace$11 = "source";
var description$11 = "These attributes may be used to describe the sender of a network exchange/packet. These should be used when there is no client/server relationship between the two sides, or when that relationship is unknown. This covers low-level network interactions (e.g. packet tracing) where you don't know if there was a connection or which side initiated it. This also covers unidirectional UDP flows and peer-to-peer communication where the \"user-facing\" surface of the protocol / API doesn't expose a clear notion of client and server.\n";
var attributes$11 = {
	"source.address": {
...
//#endregion
//#region src/agent-tools/data/system.json
var namespace$10 = "system";
var description$10 = "Describes System attributes";
var attributes$10 = { "system.device": {
...
//#endregion
//#region src/agent-tools/data/telemetry.json
var namespace$9 = "telemetry";
var description$9 = "This document defines attributes for telemetry SDK.\n";
var attributes$9 = {
	"telemetry.sdk.name": {
...
//#endregion
//#region src/agent-tools/data/test.json
var namespace$8 = "test";
var description$8 = "This group describes attributes specific to [software tests](https://wikipedia.org/wiki/Software_testing).\n";
var attributes$8 = {
	"test.suite.name": {
...
//#endregion
//#region src/agent-tools/data/thread.json
var namespace$7 = "thread";
var description$7 = "These attributes may be used for any operation to store information about a thread that started a span.\n";
var attributes$7 = {
	"thread.id": {
...
//#endregion
//#region src/agent-tools/data/tls.json
var namespace$6 = "tls";
var description$6 = "This document defines semantic convention attributes in the TLS namespace.";
var attributes$6 = {
	"tls.cipher": {
		...
		"stability": "development",
		"examples": ["TLS_RSA_WITH_3DES_EDE_CBC_SHA", "TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256"]
	},
...
//#endregion
//#region src/agent-tools/data/url.json
var namespace$5 = "url";
var description$5 = "Attributes describing URL.";
var attributes$5 = {
	"url.domain": {
...
//#endregion
//#region src/agent-tools/data/user.json
var namespace$4 = "user";
var description$4 = "Describes information about the user.";
var attributes$4 = {
	"user.email": {
...
//#endregion
//#region src/agent-tools/data/v8js.json
var namespace$3 = "v8js";
var description$3 = "Describes V8 JS Engine Runtime related attributes.";
var attributes$3 = {
	"v8js.gc.type": {
...
//#endregion
//#region src/agent-tools/data/vcs.json
var namespace$2 = "vcs";
var description$2 = "This group defines the attributes for [Version Control Systems (VCS)](https://wikipedia.org/wiki/Version_control).\n";
var attributes$2 = {
	"vcs.repository.url.full": {
		...
		"stability": "development",
		"examples": ["https://github.com/opentelemetry/open-telemetry-collector-contrib", "https://gitlab.com/my-org/my-project/my-projects-project/repo"]
	},
	"vcs.repository.name": {
...
//#endregion
//#region src/agent-tools/data/webengine.json
var namespace$1 = "webengine";
var description$1 = "This document defines the attributes used to describe the packaged software running the application code.\n";
var attributes$1 = {
	"webengine.name": {
...
//#endregion
//#region src/agent-tools/data/zos.json
var namespace = "zos";
var description = "This document defines attributes of a z/OS resource.\n";
var attributes = {
	"zos.smf.id": {
...
//#endregion
//#region src/agent-tools/lookup-otel-semantics.ts
const namespaceData = {
	android: android_default,
	app: app_default,
	artifact: artifact_default,
	aspnetcore: aspnetcore_default,
	aws: aws_default,
	azure: azure_default,
	browser: browser_default,
	cassandra: cassandra_default,
	cicd: cicd_default,
	client: client_default,
	cloud: cloud_default,
	cloudevents: cloudevents_default,
	cloudfoundry: cloudfoundry_default,
	code: code_default,
	container: container_default,
	cpu: cpu_default,
	cpython: cpython_default,
	...
	enduser: enduser_default,
	error: error_default,
	faas: faas_default,
	feature_flags: feature_flags_default,
	file: file_default,
	gcp: gcp_default,
	gen_ai: gen_ai_default,
	geo: geo_default,
	go: go_default,
	...
	v8js: v8js_default,
	vcs: vcs_default,
	webengine: webengine_default,
	zos: zos_default
};
/**
* Lookup OpenTelemetry semantic convention attributes for a given namespace
*/
async function lookupOtelSemantics(namespace$73, searchTerm, dataset, apiService, organizationSlug, projectId) {
	const normalizedNamespace = namespace$73.replace(/-/g, "_");
	const data = namespaceData[normalizedNamespace];
	if (!data) {
		const allNamespaces = Object.keys(namespaceData);
		const suggestions = allNamespaces.filter((ns) => ns.includes(namespace$73) || namespace$73.includes(ns)).slice(0, 3);
		return suggestions.length > 0 ? `Namespace '${namespace$73}' not found. Did you mean: ${suggestions.join(", ")}?` : `Namespace '${namespace$73}' not found. Use 'list' to see all available namespaces.`;
	}
	let response = `# OpenTelemetry Semantic Conventions: ${data.namespace}\n\n`;
	response += `${data.description}\n\n`;
	if (data.custom) response += "**Note:** This is a custom namespace, not part of standard OpenTelemetry conventions.\n\n";
	let attributes$73 = Object.entries(data.attributes);
	if (searchTerm) {
		const lowerSearch = searchTerm.toLowerCase();
		attributes$73 = attributes$73.filter(([key, attr]) => key.toLowerCase().includes(lowerSearch) || attr.description.toLowerCase().includes(lowerSearch));
	}
	response += `## Attributes (${attributes$73.length} ${searchTerm ? "matching" : "total"})\n\n`;
	const sortedAttributes = attributes$73.sort(([a], [b]) => a.localeCompare(b));
	for (const [key, attr] of sortedAttributes) {
		response += `### \`${key}\`\n`;
		response += `- **Type:** ${attr.type}\n`;
		response += `- **Description:** ${attr.description}\n`;
		if (attr.stability) response += `- **Stability:** ${attr.stability}\n`;
		if (attr.examples && attr.examples.length > 0) response += `- **Examples:** ${attr.examples.map((ex) => `\`${typeof ex === "object" ? JSON.stringify(ex) : String(ex)}\``).join(", ")}\n`;
		if (attr.note) response += `- **Note:** ${attr.note}\n`;
		response += "\n";
	}
	return response;
}
...
*/
function createOtelLookupTool(apiService, organizationSlug, projectId) {
	return (0, ai.tool)({
		description: "Look up OpenTelemetry semantic convention attributes for a specific namespace. OpenTelemetry attributes are universal standards that work across all datasets.",
		parameters: zod.z.object({
			namespace: zod.z.string().describe("The OpenTelemetry namespace to look up (e.g., 'gen_ai', 'db', 'http', 'mcp')"),
			searchTerm: zod.z.string().optional().describe("Optional search term to filter attributes"),
			dataset: zod.z.enum([
				"spans",
				"errors",
				"logs"
			]).describe("REQUIRED: Dataset to check attribute availability in. The agent MUST specify this based on their chosen dataset.")
		}),
		execute: async ({ namespace: namespace$73, searchTerm, dataset }) => {
			try {
				return await lookupOtelSemantics(namespace$73, searchTerm, dataset, apiService, organizationSlug, projectId);
			} catch (error) {
				if (error instanceof require_errors.UserInputError) return `Error: ${error.message}`;
				throw error;
			}
		}
	});
...
//#endregion
Object.defineProperty(exports, 'createOtelLookupTool', {
  enumerable: true,
  get: function () {
    return createOtelLookupTool;
  }
});
Object.defineProperty(exports, 'lookupOtelSemantics', {
  enumerable: true,
  get: function () {
    return lookupOtelSemantics;
  }
});
//# sourceMappingURL=lookup-otel-semantics-BbriXZAx.cjs.map