...
function createDatasetFieldsTool(apiService, organizationSlug, dataset, projectId) {
	return tool({
		...
		parameters: z.object({ includeExamples: z.boolean().describe("Include example values for each field (set to false if you don't need examples)") }),
...
//#endregion
export { createDatasetFieldsTool, discoverDatasetFields, getCommonPatterns, getFieldExamples };
//# sourceMappingURL=discover-dataset-fields-BEnyqPSq.js.map