...
var search_docs_default = defineTool({
	...
	inputSchema: {
		query: z.string().trim().min(2, "Search query is too short. Please provide at least 2 characters.").max(200, "Search query is too long. Please keep your query under 200 characters.").describe("The search query in natural language. Be specific about what you're looking for."),
		maxResults: z.number().int().min(1).max(10).default(3).describe("Maximum number of results to return (1-10)").optional(),
...
//#endregion
export { search_docs_default };
//# sourceMappingURL=search-docs-DIm3ykOg.js.map